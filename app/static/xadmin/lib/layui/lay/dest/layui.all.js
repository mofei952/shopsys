...
layui.define("jquery", function (i) {
    "use strict";
    var t = layui.jquery, a = (layui.hint(), layui.device()), e = "element", l = "layui-this", n = "layui-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (i) {
        ...
        var e = t(".layui-tab[lay-filter=" + i + "]"), l = e.children(".layui-tab-title"),
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, a, s) {
                var o = s || t(this), a = a || o.index(), c = o.parents(".layui-tab"),
                ...
                var e = a || t(this).parent(), n = e.index(), s = e.parents(".layui-tab"),
...
layui.define("layer", function (e) {
    "use strict";
    var i = layui.jquery, a = layui.layer, t = layui.hint(), n = layui.device(), l = "form", s = ".layui-form",
        c = "layui-this", r = "layui-disabled", u = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
    ...
    u.prototype.set = function (e) {
        ...
        var a = this, n = {
            select: function () {
                var e = "请选择", a = "layui-form-select", t = "layui-select-title", n = i(s).find("select"),
                    u = function (e, n) {
                ...
                n.each(function (n, l) {
                    var s = i(this), u = s.next("." + a), d = this.disabled, f = l.value,
                ...
                a.each(function (a, n) {
                    ...
                    "switch" === s && (s = "_" + s);
                    var u = e[s] || e.checkbox, o = l.next("." + u[0]),
                        d = i(['<div class="layui-unselect ' + u[0] + (n.checked ? " " + u[1] : "") + (c ? " layui-checkbox-disbaled " + r : "") + '">', {_switch: "<i></i>"}[s] || "<span>" + (n.title || "勾选") + '</span><i class="layui-icon">&#xe618;</i>', "</div>"].join(""));
                    o[0] && o.remove(), l.after(d), t.call(this, d, u)
                })
            }, radio: function () {
                var e = "layui-form-radio", a = ["&#xe643;", "&#xe63f;"], t = i(s).find("input[type=radio]"),
                    n = function (t) {
                        var n = i(this), c = "layui-anim-scaleSpring";
                        t.on("click", function () {
                            var r = n[0].name, u = n.parents(s), o = n.attr("lay-filter"),
                ...
                t.each(function (t, l) {
                    var s = i(this), c = s.next("." + e), u = this.disabled,
    ...
    var o = function () {
        var e = i(this), t = d.config.verify, c = null, r = "layui-form-danger", u = {}, o = e.parents(s),
            f = o.find("*[lay-verify]"), y = e.parents("form")[0], v = o.find("input,select,textarea"),
            h = e.attr("lay-filter");
